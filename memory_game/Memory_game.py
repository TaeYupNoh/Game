...
def setup(level):
    ...
    number_count=min(number_count,20) # 20 초과하면 20으로 처리
...
def shuffle_grid(number_count):
    ...
    button_size=110 # gird cell 내에 실제로 그려질 버튼 크기
...
def check_number_buttons(pos):
    ...
    # 모든 숫자를 다 맞췄다면? 레벨을 높여서 다시 시작화면으로 감
...
game_font = pygame.font.Font(resource_path("BRADHITC.TTF"), 120)
